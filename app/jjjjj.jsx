...
export default class HuoZhuanDing extends React.Component {
    ...
    // 存期
    showSavingTimeListBox(value) {
        this.setState({
            savingTime: value
        })
    }
    // 转存方式
    showSavingTypeListBox(value) {
        this.setState({
            savingType: value
        })
    }
    ...
    savingResult() {
        ...
        $Fetch(API.API_SET_HUO_ZHUAN_DING, {
            ...
            data: {
                ...
                reservoirType: 'T1',//储种
                reservoirNo: that.state.savingTime[0],//储种号
                cipher: that.state.realPwd,//交易密码
                flag: that.state.savingType[0],//转存标志
        ...
        return (
            <div>
                <div ref="myInput">
                    ...
                    <WhiteSpace size="lg" />
                    <WingBlank size="lg">
                        <Button type="primary" size="default" onTap={this.savingConfirm.bind(this)} disabled={this.state.buttonAddDisabled}>确认</Button>
                    </WingBlank>
                </div>
                <div ref="myConfirm" style={{ display: "none" }}>
                    <div className="savings-zhiququereng-democode">
                        ...
                        <MbankPublicConfirm.Group>
                            ...
                            <MbankPublicConfirm title="存期" content={savingTimeLabel} />
                    ...
                    <WhiteSpace size="lg" />
                    <WingBlank size="lg">
                        <Button type="primary" size="default" onTap={this.savingResult.bind(this)} disabled={this.state.buttonDisabled}>确认</Button>
                    </WingBlank>
                </div>
